...
Snack5 (Bonus) :
Gnera un numero a caso compreso tra 1 e 100;
Chiedi un numero all'utente finchè non indovina il numero generato casualmente ;
Ogni volta che l'utente inserisce un numero, dire se è maggiore o minore rispetto al numero generato;
Alla fine stampa il numero di tentativi che ci sono voluti per indovinare il numero generato.
